<?php
/*
Plugin Name: Yousuf Plugin
Plugin URI: http://www.Yousuf.com/
...
extract( wp_parse_args( ( array ) $instance, $defaults ) ); ?>
		...
		<p>
			...
			$options = array(
				...
				'Shajek' => __( 'Shajek', 'text_domain' ),
				'Banderban' => __( 'Banderban', 'text_domain' ),
				'Khagrasori' => __( 'Khagrasori', 'text_domain' ),
			);
